...
export class App {
  ...
  private initializeSwaggerUI() {
    this.app.doc31('/swagger', (c) => {
      ...
      return {
        ...
        \nJioSaavn API, accessible at [saavn.dev](https://jiosaavn-api-tmkh.onrender.com), is an unofficial API that allows users to download high-quality songs from [JioSaavn](https://jiosaavn.com). 
    ...
    this.app.get(
      ...
      apiReference({
        ...
        metaData: {
          ...
          creator: 'Deepak Goswami',
          publisher: 'Deepak Goswami',
          robots: 'index, follow',
          description:
  ...
  private initializeRouteFallback() {
    this.app.notFound((ctx) => {
      return ctx.json({ success: false, message: 'route not found, check docs at https://jiosaavn-api-tmkh.onrender.com/docs' }, 404)
    })
  }
